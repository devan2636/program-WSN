...
int thisAddress = 201; // alamat yang digunakan oleh node
int headerFrom = 202; // alamat yang digunakan oleh node
...
//[9] Program ketika gateway mode receive
  ...
  // Mengirim command ke node B
      ...
      String message = kirim + " A " + (String)suhu + " " + (String)kelembapan + " "; // Data yang akan dikirimkan
      message.toCharArray(buff, len);

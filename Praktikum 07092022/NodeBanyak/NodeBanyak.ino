...
int thisAddress = 304; // alamat yang digunakan oleh node
//int headerFrom = 202; // alamat yang digunakan oleh node
int headerTo = 301; //alamat yang akan dituju
String dataIn;
...
//[7] Program ketika gateway mode receive
  ...
  if (rf95.recv(buf, &len)){
    ...
    if (dataIn == "OK"){
      ...
      String message = "Data dari node C, RSSI : "; // Data yang akan dikirimkan

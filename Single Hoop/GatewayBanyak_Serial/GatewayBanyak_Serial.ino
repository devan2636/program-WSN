...
int thisAddress = 200; // alamat yang digunakan oleh gateway
int headerFrom = 200; // alamat yang digunakan oleh gateway
String dataIn;
String cmd_balik = "OK";
...
//[4] Komunikasi serial dengan ESP32
#include <SoftwareSerial.h>
SoftwareSerial Serial2 (3,4); // RX 3, TX 4
...
{
  for (int ToNode = 201; ToNode <= 203; ToNode++){
